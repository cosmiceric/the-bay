...
class __TwigTemplate_fa946d7a4015219701a5a6d1840ab946bffe35b9e713c6478e34af32dc657ff7 extends Craft\BaseTemplate
{
...
";
        // line 5
        echo $context["forms"]->gettextField(array("label" => \Craft\Craft::t("Access Key ID"), "id" => "keyId", "name" => "keyId", "value" => $this->getAttribute((isset($context["settings"]) ? $context["settings"] : $this->getContext($context, "settings")), "keyId"), "errors" => $this->getAttribute((isset($context["settings"]) ? $context["settings"] : $this->getContext($context, "settings")), "getErrors", array(0 => "keyId"), "method"), "class" => "google-key-id", "required" => true));
        // line 13
        echo "

";
        // line 15
        echo $context["forms"]->gettextField(array("label" => \Craft\Craft::t("Secret Access Key"), "id" => "secret", "name" => "secret", "value" => $this->getAttribute((isset($context["settings"]) ? $context["settings"] : $this->getContext($context, "settings")), "secret"), "errors" => $this->getAttribute((isset($context["settings"]) ? $context["settings"] : $this->getContext($context, "settings")), "getErrors", array(0 => "secret"), "method"), "class" => "google-secret-key", "required" => true));
        // line 23
        echo "
...
";
        ...
        <tr>
            <td>
                ";
        // line 29
        echo $context["forms"]->getselect(array("id" => "bucket", "name" => "bucket", "options" => array($this->getAttribute((isset($context["settings"]) ? $context["settings"] : $this->getContext($context, "settings")), "bucket") => $this->getAttribute((isset($context["settings"]) ? $context["settings"] : $this->getContext($context, "settings")), "bucket")), "value" => $this->getAttribute((isset($context["settings"]) ? $context["settings"] : $this->getContext($context, "settings")), "bucket"), "disabled" => true, "class" => "google-bucket-select"));
        // line 36
        echo "
            </td>
            <td>
...
";
        // line 65
        echo $context["forms"]->gettextField(array("label" => \Craft\Craft::t("URL Prefix "), "instructions" => \Craft\Craft::t("If you have set up a CNAME record pointing to this bucket, you can enter it here. Otherwise leave this setting alone."), "id" => "urlPrefix", "class" => "ltr", "name" => "urlPrefix", "value" => $this->getAttribute((isset($context["settings"]) ? $context["settings"] : $this->getContext($context, "settings")), "urlPrefix"), "errors" => $this->getAttribute((isset($context["settings"]) ? $context["settings"] : $this->getContext($context, "settings")), "getErrors", array(0 => "url_prefix"), "method"), "required" => true, "class" => "google-url-prefix"));
        // line 75
        echo "
